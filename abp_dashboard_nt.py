...
def load_data():
    ...
    return overview, health, healthwcd, edu, agri, basicinf, social, disshp, blkshp, abpshp, healthdf, healthdf1, edu1, agri1, basicinf1, social1, merged_df, normdf

# Load data
overview, health, healthwcd, edu, agri, basicinf, social, disshp, blkshp, abpshp, healthdf, healthdf1, edu1, agri1, basicinf1, social1, merged_df, normdf = load_data()
...
# Add hover functionality for abpshp with dynamically selected columns
